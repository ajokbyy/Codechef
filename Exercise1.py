...
print( arr['February']-arr['January']) # 1. In Feb, how many dollars you spent extra compare to January?

print("2. Find out your total expense in first quarter (first three months) of the year.")
print(arr.values()) # print all the values
...
# Problam 2 - You have a list of your favourite marvel super heros.
...
#problan 3 -Create a list of all odd numbers between 1 and a max number. Max number is something you need to take from a user using input() function
